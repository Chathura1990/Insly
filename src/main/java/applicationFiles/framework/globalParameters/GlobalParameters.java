...
public class GlobalParameters {
    ...
    public static final String WEBSITE_URL = "https://login.salesforce.com/";
    public static final String VALID_USERNAME = "chathurasanjeew@gmail.com";//automationtesteritsm1-hlyc@force.com admin
    public static final String VALID_PASSWORD = "15154556c";
